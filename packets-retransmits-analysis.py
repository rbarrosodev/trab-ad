...
# Load JSON data
packets_retransmits_data = json.load(open("data/packets-retransmits_normalized.json"))

# Prepare data for analysis
timestamps = [datetime.fromtimestamp(data["ts"]) for data in packets_retransmits_data]
values = [data["val"] for data in packets_retransmits_data]
